...
<body>
	<div class="container">
		...
		<form method="post" action="/lesson04/ex01/add-user"> <!-- insert는 무조건 post이다. -->
			...
			<div class="form-group">
				...
				<input type="text" id="yyyymmdd" name="yyyymmdd" class="form-control col-4" placeholder="예)20000101">
			</div>
			<div class="form-group">
